...
public enum ExceptionType {
    ...
    TRAINING_PLAN_GENERATION_ERROR(HttpStatus.BAD_REQUEST, "Issue while saving training plan"),
    ...
    USER_EXERCISE_NOT_FOUND(HttpStatus.NOT_FOUND, "User exercise not found"),
    USER_EXERCISE_ALREADY_EXISTS(HttpStatus.CONFLICT, "User exercise already exists");

...
import org.lukawska.trainsmart.gymfinder.application.dto.GymLocationResult;
...
public class FindGymMapper {
    ...
    public static FindGymResponse mapToFindGymResponse(GymLocationResult locationResponse, double distance) {
